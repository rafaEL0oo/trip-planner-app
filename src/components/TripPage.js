              ...
              {trip.urlMetadata && (
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2 }}>
                    {trip.urlMetadata.image && (
                      <Box
                        component="img"
                        src={trip.urlMetadata.image}
                        alt={trip.urlMetadata.title}
                        sx={{
                          width: 80,
                          height: 80,
                          objectFit: 'cover',
                    ...
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                      <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', mb: 1 }}>
                        ...
                        >
                          {trip.urlMetadata.title}
                        </Typography>
                        <Link
                          href={trip.urlMetadata.url}
                          target="_blank"
                      ...
                      <Box sx={{ display: 'flex', gap: 1, alignItems: 'center', flexWrap: 'wrap' }}>
                        {trip.urlMetadata.site && (
                          <Chip
                            icon={<LinkIcon />}
                            label={trip.urlMetadata.site}
                            size="small"
                            sx={{ 
                        ...
                        {trip.urlMetadata.author && (
                          <Chip
                            label={`by ${trip.urlMetadata.author}`}
                            size="small"
                            sx={{ 
                              bgcolor: 'rgba(255, 255, 255, 0.2)',
                              color: 'white'
